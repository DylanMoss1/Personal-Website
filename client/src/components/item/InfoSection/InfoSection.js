...
const InfoSection = ({darkPanel, id, imgStart, topLine, headline, description1, description2, description3, buttonLabel, img, alt, arrow}) => {
            ...
            <InfoContainer darkPanelBg={darkPanel} id={id}>
                <InfoWrapper>
                    <InfoRow imgStart={imgStart}>
                        <Column1>
                            <TextWrapper leftText={!darkPanel}>
